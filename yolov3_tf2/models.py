...
def YoloV3Tiny(size=None, channels=1, anchors=yolo_tiny_anchors,
               masks=yolo_tiny_anchor_masks, classes=80, training=False):
    x = inputs = Input([208, 208, 3], name='input')
...
def YoloLoss(anchors, classes=80, ignore_thresh=0.5):
    def yolo_loss(y_true, y_pred):
        ...
        print("\n__DEBUG 0:__")
        print("true_xy: " + str(true_xy))
        print("pred_xy: " + str(pred_xy))

        remove_me = tf.reduce_sum(tf.square(true_xy - pred_xy), axis=-1)
        ...
        """FIXED: see above ? # TODO: use binary_crossentropy instead
